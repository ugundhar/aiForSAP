...
# tools=[multiply,openNotificatoins,retrieveTechnicalObjects]
...
# result = graph.invoke({"messages": ["pump is not working"]},config=config)
...
## working up to the tools calculator,retriver,opennotifications
